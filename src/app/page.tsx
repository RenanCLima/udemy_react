    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      <section className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        <h1 className="text-6xl">
          Bem Vindo ao <span className="text-blue-600">Portfólio!</span>
        </h1>
      ...
      <section>
        <div className="w-full px-20 bg-secondary">
          ...
          <p className="text-xl mb-4">
            Esse portfólio foi criado como parte de um curso moderno de React e
            Next.js, demonstrando as melhores práticas e tecnologias atuais de
            desenvolvimento web
          </p>
          <p className="text-xl">
            Explore as diferentes seções para ver como utilizamos componentes
            reutilizados com roteamento dinâmico, e integrações com serviços
            modernos como Supabase
          </p>
        </div>
      </section>
    </div>
